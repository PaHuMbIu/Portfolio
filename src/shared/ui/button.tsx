    ...
    variants: {
      variant: {
        ...
        glow: cn(
          ...
          "border-purple-400/40 hover:border-purple-400/80 active:border-purple-400/80",
          "hover:from-purple-600/40 hover:via-purple-500/30 hover:to-pink-600/40",
          "active:from-purple-600/40 active:via-purple-500/30 active:to-pink-600/40",
          "hover:shadow-2xl hover:shadow-purple-500/40 hover:-translate-y-0.5",
          "active:shadow-2xl active:shadow-purple-500/40 active:-translate-y-0.5",
          ...
          "active:before:from-purple-500/30 active:before:via-pink-400/30 active:before:to-purple-500/30",
          "after:absolute after:inset-0 after:bg-linear-to-r",
          "after:from-transparent after:via-white/10 after:to-transparent",
          "after:-translate-x-full hover:after:translate-x-full active:after:translate-x-full",
        ...
        glowBlue: cn(
          ...
          "border-blue-400/40 hover:border-blue-400/80 active:border-blue-400/80",
          "hover:from-blue-600/40 hover:via-cyan-500/30 hover:to-teal-600/40",
          "active:from-blue-600/40 active:via-cyan-500/30 active:to-teal-600/40",
          "hover:shadow-2xl hover:shadow-blue-500/40 hover:-translate-y-0.5",
          "active:shadow-2xl active:shadow-blue-500/40 active:-translate-y-0.5",
          "before:absolute before:inset-0 before:bg-linear-to-r",
          ...
          "active:before:from-blue-500/30 active:before:via-cyan-400/30 active:before:to-teal-500/30",
          "after:absolute after:inset-0 after:bg-linear-to-r",
          "after:from-transparent after:via-white/10 after:to-transparent",
          "after:-translate-x-full hover:after:translate-x-full active:after:translate-x-full",
          "after:transition-transform after:duration-1000",
