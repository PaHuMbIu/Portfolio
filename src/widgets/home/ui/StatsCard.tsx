...
export const StatsCard = ({ Icon, keyId, color, value, index }: StatsCardProps) => {
  ...
  return (
    ...
    >
      <div className="relative xl:p-6 p-4 rounded-2xl bg-linear-to-br from-white/5 to-white/0 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
